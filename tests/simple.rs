...
mod tests {
    ...
    #[test]
    fn compiles_and_new() {
        sibling_vecs!(SiblingVecs3, i32, f64, bool);
    ...
    fn zero_capacity_edge() {
        sibling_vecs!(SiblingVecs2, i32, f64);
        let v = SiblingVecs2::with_capacity(0);
    ...
    fn alignment_and_padding_handled() {
        sibling_vecs!(SiblingVecsU, u8, u64); // u64 needs 8-byte align, u8 doesn't
